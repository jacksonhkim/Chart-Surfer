class SoundManager {
    ...
    playLevelUp() {
        if (!this.ctx) return;
        this.playTone(523, 'square', 0.1, 0, 0.1);   // C5
        this.playTone(659, 'square', 0.1, 0.1, 0.1); // E5
        this.playTone(784, 'square', 0.1, 0.2, 0.1); // G5
        this.playTone(1046, 'square', 0.5, 0.3, 0.2); // C6 (강조)
    }
